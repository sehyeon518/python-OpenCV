...
img = cv2.imread('practice_hole\hole.jpg')
...
# 트랙바 추가
cv2.createTrackbar('Hue Low', 'HLS Image', 0, 179, update_hls)
cv2.createTrackbar('Hue High', 'HLS Image', 60, 179, update_hls)
cv2.createTrackbar('Lightness Low', 'HLS Image', 0, 255, update_hls)
...
cv2.createTrackbar('Saturation High', 'HLS Image', 255, 255, update_hls)
